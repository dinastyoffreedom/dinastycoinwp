...
/*
  Copyright (c) 2018 Monero-Integrations
   Integration for Dinastycoin by Dinasty of Freedom trust
*/
...
require_once('class-dinastycoin-base58.php');

class Dinastycoin_Cryptonote
{
    protected $ed25519;
    public function __construct()
    {
        $this->ed25519 = new ed25519();
        $this->base58 = new Dinastycoin_base58();
        $this->address_prefix = DINASTYCOIN_GATEWAY_ADDRESS_PREFIX;
        $this->address_prefix_integrated = DINASTYCOIN_GATEWAY_ADDRESS_PREFIX_INTEGRATED;
    }
    ...
    /*
     * Create a valid base58 encoded DINASTYCOIN address from public keys
     *
     * @param string Public spend key
     * @param string Public view key
     *
     * @return string Base58 encoded DINASTYCOIN address
     */
...
/*
 * Decode a base58 encoded Dinastycoin address
 *
 * @param string A base58 encoded Dinastycoin address
 *
 ...
 */
    ...
    /*
     * Generate a Dinastycoin  address from seed
     *
     * @param string Hex string to use as seed
     *
     * @return string A base58 encoded Dinastycoin  address
     */
