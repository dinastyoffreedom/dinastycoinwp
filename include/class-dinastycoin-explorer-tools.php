 ...
 * @author mosu-forge
 * @author for Dinastycoin support by Dinasty of Freedom trust
 *
 */

defined( 'ABSPATH' ) || exit;

class Dinastycoin_Explorer_Tools
{
    private $url;
    public function __construct($testnet = false)
    {
        $this->url = $testnet ? DINASTYCOIN_GATEWAY_TESTNET_EXPLORER_URL : DINASTYCOIN_GATEWAY_MAINNET_EXPLORER_URL;
